...
namespace Data
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual int CustomerInsert(string customerID, string companyName)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CustomerInsert", customerIDParameter, companyNameParameter);
        }
    
        public virtual int CustomerUpdate(string customerID, string companyName)
        {
            var customerIDParameter = customerID != null ?
                new ObjectParameter("CustomerID", customerID) :
                new ObjectParameter("CustomerID", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CustomerUpdate", customerIDParameter, companyNameParameter);
        }
        ...
        public virtual ObjectResult<GetOrders_Result> GetOrders(string customer, Nullable<int> employee, Nullable<System.DateTime> dateFrom, Nullable<System.DateTime> dateTo)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetOrders_Result>("GetOrders", customerParameter, employeeParameter, dateFromParameter, dateToParameter);
        }
        ...
        public virtual ObjectResult<SearchOrder_Result> SearchOrder(string zaposleni, string klijent, string proizvod)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SearchOrder_Result>("SearchOrder", zaposleniParameter, klijentParameter, proizvodParameter);
        }
        ...
        public virtual ObjectResult<Order> SearchOrder1(string zaposleni, string klijent, string proizvod)
        {
            var zaposleniParameter = zaposleni != null ?
                new ObjectParameter("Zaposleni", zaposleni) :
                new ObjectParameter("Zaposleni", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Order>("SearchOrder1", zaposleniParameter, klijentParameter, proizvodParameter);
        }
    
        public virtual ObjectResult<Order> SearchOrder1(string zaposleni, string klijent, string proizvod, MergeOption mergeOption)
        {
            var zaposleniParameter = zaposleni != null ?
                new ObjectParameter("Zaposleni", zaposleni) :
                new ObjectParameter("Zaposleni", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Order>("SearchOrder1", mergeOption, zaposleniParameter, klijentParameter, proizvodParameter);
        }
    }
}
